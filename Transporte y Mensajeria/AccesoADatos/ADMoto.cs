    ...
    public class ADMoto
    {
        ...
        public void AltaMoto(Moto moto)
        {
            ...
            try
            {
                ...
                using (cmd = new MySqlCommand("Insert into motos(descripcion,fechaCompra,precioCompra,aumento,cilindrada) values (@descripcion,@fechaCompra,@precioCompra,@aumento,@cilindrada)", conexion.retornarCN()))
                {
                    ...
                    cmd.Parameters.AddWithValue("@descripcion", moto.Modelo);
        ...
        public void ModificacionMoto(Moto moto)
        {
            ...
            {
                conexion.abrir();
                using (cmd = new MySqlCommand("UPDATE motos SET descripcion=@descripcion, fechaCompra=@fechaCompra, precioCompra=@precioCompra, aumento=@aumento, cilindrada=@cilindrada WHERE idMoto=@idMoto", conexion.retornarCN()))
                {
