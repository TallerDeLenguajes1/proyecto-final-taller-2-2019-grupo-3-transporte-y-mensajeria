    ...
    public class ADAvion
    {
        ...
        public void AltaAvion(Avion avion)
        {
            ...
            try
            {
                ...
                using (cmd = new MySqlCommand("Insert into aviones(descripcion,fechaCompra,precioCompra,aumento) values (@descripcion,@fechaCompra,@precioCompra,@aumento)", conexion.retornarCN()))
                {
                    cmd.Parameters.AddWithValue("@descripcion", avion.Modelo);
        ...
        public void BajaAvion(int idAvion)
        {
            ...
            {
                conexion.abrir();
                using (cmd = new MySqlCommand("DELETE FROM motos WHERE idAvion = @idAvion", conexion.retornarCN()))
                {
        ...
        public void ModificacionAvion(Avion Avion)
        {
            ...
            {
                conexion.abrir();
                using (cmd = new MySqlCommand("UPDATE aviones SET descripcion=@descripcion, fechaCompra=@fechaCompra, precioCompra=@precioCompra, aumento=@aumento,  WHERE idAvion=@idAvion", conexion.retornarCN()))
                {
            ...
            try
            {
                ...
                using (cmd = new MySqlCommand("Select * from aviones", conexion.retornarCN()))
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        nuevoAvion = new Avion(modelo, fechaCompra, precioCompra, aumento);
